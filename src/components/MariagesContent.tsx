  ...
  return (
    <main>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative z-10 py-[8rem] max-md:py-16 px-4 md:px-8">
          <div className="max-w-7xl mx-auto">
            <h1 className="font-platform text-[5rem] max-md:text-[2.25rem] font-normal leading-[1] tracking-[-0.01em] text-white mb-4">Photobooth pour mariages</h1>
            <h2 className="font-platform text-[2.5rem] max-md:text-[1.25rem] font-normal leading-[1.1] tracking-[-0.01em] text-white/90 mb-6 max-w-[40ch]">Créez des souvenirs inoubliables pour le plus beau jour de votre vie</h2>
            <p className="font-suisse text-[max(14px,1.25rem)] leading-[1.5] text-white/80 mb-8 max-w-[60ch]">Notre photobooth apporte une touche de fun et d&apos;élégance à votre mariage. Des photos personnalisées que vos invités garderont précieusement.</p>
      ...
      <section className="bg-[#1E1E2A] py-[8rem] max-md:py-16">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <h2 className="font-platform text-[3rem] max-md:text-[1.75rem] font-normal leading-[1] tracking-[-0.01em] text-white mb-12 max-md:mb-8 text-center">Extras mariage</h2>
      ...
      <section className="faqs bg-[#F6F6F6] pt-[8rem] max-md:pt-10 pb-[8rem] max-md:pb-16 px-4">
        <div className="max-w-4xl mx-auto px-4 md:px-8">
          <h2 className="font-platform text-[3rem] max-md:text-[1.75rem] font-normal leading-[1] tracking-[-0.01em] text-[#1E1E2A] mb-10 max-md:mb-6 text-center">Questions fréquentes — Mariages</h2>
