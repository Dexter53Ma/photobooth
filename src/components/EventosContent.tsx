        ...
        <section className="relative overflow-hidden">
          ...
          <div className="relative z-10 py-[8rem] max-md:py-16 px-4 md:px-8">
            <div className="max-w-7xl mx-auto">
              <h1 className="font-platform text-[6.5rem] max-md:text-[2.5rem] font-normal leading-[1] tracking-[-0.01em] text-white mb-4">Photobooth pour événements</h1>
              <h2 className="font-platform text-[3rem] max-md:text-[1.5rem] font-normal leading-[1.1] tracking-[-0.01em] text-white/90 mb-6 max-w-[40ch]">Photobooth idéal pour événements d&apos;entreprise et campagnes marketing</h2>
